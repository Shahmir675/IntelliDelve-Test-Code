...
import { BlogFilters } from "../services/apiService";
...
const Blogs = () => {
  ...
  const { data: blogsResponse, isLoading, error, refetch } = useBlogs(filters);
  ...
  return (
    <div className="min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  title="Refresh blogs data and clear cache"
                >
                  ...
                  {filteredPosts.map((post) => (
                    ...
                    >
                      <div className="relative overflow-hidden">
                        <img
                          src={post.featured_image || "/images/downloaded/unsplash-photo-1560472354-b33ff0c44a43.jpg"}
                          alt={post.title}
      ...
      {/* Pagination Section */}
      {!isLoading && !error && blogsResponse?.success && totalPages > 1 && (
        <section className="py-8 bg-white dark:bg-gray-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mt-4 text-sm text-gray-600 dark:text-gray-400">
              Showing page {currentPage} of {totalPages} ({blogsResponse.data.total} total articles)
            </div>
          </div>
        </section>
      )}
